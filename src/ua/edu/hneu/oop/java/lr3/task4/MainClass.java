...
public class MainClass {
    ...
    private static final String PARAM_FORMAT = "%s=%.3f";
    private static final String HEADER_FORMAT = "For function %s=%s%nwith parameters:%n%s%nwhen x=%.3f%n";
    private static final String VALUE_FORMAT = "value = %.3f";
    private static final String VALUE_EXCEPTION_FORMAT = "value can not be calculated due %s";
    private static final String TAIL_FORMAT = "%n%s%n";
